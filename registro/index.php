...
<b>
<table width="100%" border="0" style="background-image:url(agenda_6x4_frente.jpg)">
  <tr>
    <td width="4%">&nbsp;</td>
    <td width="21%">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td><label for="user-email2">Correo electronico: </label>
      <br /></td>
    <td colspan="2"><input name="correo" type="email" id="user-email2" value="tucorreo@mail.com" required/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><p>Domicilio
       (Calle, N&uacute;mero, Colonia)
    </p></td>
    <td colspan="2"><textarea name="domicilio" rows="2" cols="40">Introduce tu domicilio completo</textarea></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
